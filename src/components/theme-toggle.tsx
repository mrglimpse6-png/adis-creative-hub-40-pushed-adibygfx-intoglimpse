...
export function ThemeToggle() {
  ...
  return (
    <div className="relative theme-toggle-enhanced">
      <Button
        onClick={toggleTheme}
        variant="ghost"
        size="sm"
        className={cn(
          // Base styles with playful rounded edges
          ...
          // Soft drop shadows for depth (3-4px blur)
          theme === "light"
      ...
      >
        ...
        <div className="relative w-7 h-7 flex items-center justify-center">
          ...
          <Sun 
            className={cn(
              "absolute h-7 w-7 transition-all duration-500 ease-out sun-icon",
              theme === "light" 
          ...
          <Moon 
            className={cn(
              "absolute h-7 w-7 transition-all duration-500 ease-out moon-icon",
              theme === "dark" 
